...
ActiveRecord::Schema.define(version: 2018_05_26_143837) do
  ...
  create_table "articles", force: :cascade do |t|
    ...
    t.index ["approved"], name: "index_articles_on_approved"
  ...
  create_table "discussions", force: :cascade do |t|
    ...
    t.index ["pinned", "created_at"], name: "index_discussions_on_pinned_and_created_at"
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.boolean "pinned", default: false
    t.index ["answer"], name: "index_questions_on_answer"
    t.index ["author_id"], name: "index_questions_on_author_id"
    t.index ["major_id"], name: "index_questions_on_major_id"
    t.index ["pinned", "created_at"], name: "index_questions_on_pinned_and_created_at"
    t.index ["pinned"], name: "index_questions_on_pinned"
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["generation", "last_name", "first_name"], name: "index_users_on_generation_and_last_name_and_first_name", order: { generation: :desc }
  ...
  create_table "video_links", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pinned", "created_at"], name: "index_video_links_on_pinned_and_created_at"
